...
const authApi = {
    login: (credentials)=>getApiClient().post('/jwt/create', credentials),
    register: (data)=>getApiClient().post('/users/', data),
    refresh: (refreshToken)=>getApiClient().post('/jwt/refresh/', {
            refresh: refreshToken
        }),
    me: ()=>getApiClient().get('/users/me/')
};
const projectsApi = {
    list: ()=>getApiClient().get('/projects/'),
    retrieve: (id)=>getApiClient().get(`/projects/${id}/`),
    create: (data)=>getApiClient().post('/projects/', data),
    update: (id, data)=>getApiClient().patch(`/projects/${id}/`, data),
    delete: (id)=>getApiClient().delete(`/projects/${id}/`)
};
const todosApi = {
    listByProject: (projectId)=>getApiClient().get(`/projects/${projectId}/todos/`),
    retrieve: (todoId)=>getApiClient().get(`/todos/${todoId}/`),
    create: (projectId, data)=>getApiClient().post(`/projects/${projectId}/todos/`, data),
    update: (todoId, data)=>getApiClient().patch(`/todos/${todoId}/`, data),
    delete: (todoId)=>getApiClient().delete(`/todos/${todoId}/`)
};
const tagsApi = {
    list: ()=>getApiClient().get('/tags/')
};
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d1510ef._.js.map